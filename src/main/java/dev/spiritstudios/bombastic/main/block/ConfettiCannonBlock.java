...
public class ConfettiCannonBlock extends BlockWithEntity {
    ...
    protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        return switch (state.get(FACING)) {
            ...
            case NORTH -> VoxelShapeHelper.rotateHorizontal(Direction.NORTH, Direction.EAST, VoxelShapeHelperFix.rotateZ(UP));
            case SOUTH -> VoxelShapeHelper.rotateHorizontal(Direction.SOUTH, Direction.EAST, VoxelShapeHelperFix.rotateZ(UP));
            case WEST -> VoxelShapeHelper.rotateHorizontal(Direction.WEST, Direction.EAST, VoxelShapeHelperFix.rotateZ(UP));
